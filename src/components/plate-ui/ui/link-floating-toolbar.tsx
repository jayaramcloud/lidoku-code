  ...
  const input = (
    <div className='flex w-[330px] flex-col' {...inputProps}>
      <div className='flex items-center'>
        ...
        <FloatingLinkUrlInput className={inputVariants({ h: 'sm', variant: 'ghost' })} placeholder='Paste link' data-plate-focus />
      </div>
      ...
      <div className='flex items-center'>
        ...
        <input className={inputVariants({ h: 'sm', variant: 'ghost' })} placeholder='Text to display' data-plate-focus {...textInputProps} />
      </div>
    </div>
  );
